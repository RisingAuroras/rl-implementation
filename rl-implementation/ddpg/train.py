...
from ddpg.algorithm import DDPG  # from parl.algorithms import DDPG
...
def run_train_episode(agent, env, rpm):
    ...
    while True:
        ...
        action = action.item()  # ContinuousCartPoleE输入的action为一个实数
...
if __name__ == '__main__':
    ...
    plt.rcParams['font.sans-serif'] = ['SimHei']  # 解析中文字体
    plt.xlabel("epoch")  # x的轴标签
    plt.ylabel("reward")  # x的轴标签
    plt.title("The Image Of DDPG")  # 图像名称
    plt.show()
